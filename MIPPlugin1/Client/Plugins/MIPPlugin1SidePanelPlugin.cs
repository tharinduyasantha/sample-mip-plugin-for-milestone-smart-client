...
namespace MIPPlugin1.Client
{
    ...
    /// </summary>
    public class MIPPlugin1SidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        //{
        //	return new MIPPlugin1SidePanelUserControl();
        //}
        ...
        {
            get { return MIPPlugin1Definition.MIPPlugin1SidePanel; }
        }
        ...
        {
            get { return "MIPPlugin1 Side panel"; }
        }
