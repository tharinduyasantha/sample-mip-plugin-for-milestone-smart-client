...
namespace MIPPlugin1.Admin
{
    ...
    /// </summary>
    public class MIPPlugin1ItemManager : ItemManager
    {
        private MIPPlugin1UserControl _userControl;
        private Guid _kind;

        #region Constructors

        public MIPPlugin1ItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new MIPPlugin1UserControl();
        ...
        {
            return new MIPPlugin1AddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(MIPPlugin1Definition.MIPPlugin1PluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((MIPPlugin1AddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(MIPPlugin1Definition.MIPPlugin1PluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(MIPPlugin1Definition.MIPPlugin1PluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(MIPPlugin1Definition.MIPPlugin1PluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(MIPPlugin1Definition.MIPPlugin1PluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(MIPPlugin1Definition.MIPPlugin1PluginId, _kind, fqid.ObjectId);
            return item;
        }
