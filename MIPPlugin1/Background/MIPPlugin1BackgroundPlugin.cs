...
namespace MIPPlugin1.Background
{
    /// <summary>
    ...
    /// </summary>
    public class MIPPlugin1BackgroundPlugin : BackgroundPlugin
    {
        ...
        {
            get { return MIPPlugin1Definition.MIPPlugin1BackgroundPlugin; }
        }
        ...
        {
            get { return "MIPPlugin1 BackgroundPlugin"; }
        }
